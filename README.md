...
* the [iOS client](https://github.com/ricardoquesada/unijoysticle/tree/master/client_ios) and the [Android client](https://github.com/ricardoquesada/unijoysticle/tree/master/client_android) that sends the packets to the Wi-Fi receiver
